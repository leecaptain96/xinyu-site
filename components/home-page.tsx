...
function About() { return <section id="about" className="section bg-paper"><div className="wrap grid gap-14 lg:grid-cols-[1.08fr_.92fr]">
...
function VideoShowcase() {
 ...
 return <section id="videos" className="section relative overflow-hidden bg-[#18201b] text-white"><DarkConnections/><div className="absolute -left-48 top-10 h-96 w-96 rounded-full bg-moss/40 blur-[130px]"/><div className="wrap relative"><Reveal className="grid gap-8 lg:grid-cols-[1.2fr_.8fr] lg:items-end"><div><Kicker light>SHORT VIDEO · 作品重点</Kicker><h2 className="title text-white">把复杂业务，<br/><em className="text-[#aebcaf]">讲成客户愿意停下来的内容。</em></h2></div><p className="text-sm leading-7 text-white/50">很多企业不是业务不够好，而是客户听不懂、记不住。我会先理解业务本身，再通过短视频、口播、情景表达和账号运营，把专业能力翻译成客户听得懂的语言。</p></Reveal>
...
export function HomePage() { return <><GlobalAtmosphere/><Header/><main className="relative z-10"><Hero/><About/><Capabilities/><VideoShowcase/><Scenes/><Experience/><Process/><Trust/><Cases/><Contact/></main><footer className="relative z-10 bg-[#111512] py-7 text-white/35"><div className="wrap flex flex-col gap-2 text-[10px] md:flex-row md:justify-between"><p>© 2026 石新雨 · PERSONAL BUSINESS BRAND</p><p>法律及相关服务仅作前期沟通、信息匹配与专业机构协作，不构成结果承诺。</p></div></footer></>; }
